...
<html>
  <head>
	...
	<style type="text/css">
		...
		#reset{position: relative;right: 25px}
		#pad{position: relative;right: 25px;}
	</style>
  </head>
...
<!--   			errorinfo=(String)session.getAttribute("error"); -->
  ...
  <script src="bootstrap-3.3.7-dist/js/bootstrap.min.js"></script>
		...
		<fieldset style="width: 600px"><legend>login</legend>
				...
				<div id="reset">
					账号：<input type="text" name="u.name" value="<%=name %>">
				</div>
				<p/>
				<div id="pad">密码：<input type="password" name="u.pwd"><p><br/></div>
