...
<%@page import="com.wzx.dto.Query"%>
<%@page import="java.text.SimpleDateFormat"%>
<%@page import="com.wzx.dao.inter.INewsDao"%>
...
<html>
  ...
  <script src="bootstrap-3.3.7-dist/js/bootstrap.min.js"></script>
	...
	<%	
			...
			if(request.getParameter("qcontext")!=null){
				qcontext=request.getParameter("qcontext");
			}
		...
		<div>
			<form action="midone.jsp" method="post" id="reset">
				新闻标题：
				...
				<a href="exit.jsp"><input type="button" class="button button-highlight button-rounded button-small" value="退出"> </a>
			</form>
			<form action="main.jsp?qtitle=<%=qtitle %>&qcontext=<%=qcontext %>" method="post" name="changePage">
		...
		<div style="width: 1000px">
			...
			<tr align="center">
				...
				%>
				<tr align="center">
				<td><input type="checkbox" name="single" value="<%=n.getId() %>"></td>
				<td><%=n.getNewsid() %></td>
				<td><%=n.getTitle() %></td>
				<td><%=n.getContext() %></td>
				<td><%=n.getNewsman() %></td>
				<td><%=sdf.format(n.getNewsdate()) %></td>
				<td><a href="<%=n.getPic()%>"><img style="width: 192px;height: 108px" alt="无法显示" src="<%=n.getPic() %>"></a> </td>
				<td><a href="deleteNews.jsp?id=<%=n.getId() %>"><input type="button" class="button button-3d button-caution button-small" value="删除"></a></td>
				<td><a href="update.jsp?id=<%=n.getId() %>"><input type="button" class="button button-3d button-primary button-small" value="修改"></a></td>
				</tr>
				<%}
				%>
		</table>
